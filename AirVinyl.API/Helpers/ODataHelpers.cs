...
namespace AirVinyl.API.Helpers
{
    ...
    public static class ODataHelpers
    {
        ...
        {
            var propertyInfo = instance.GetType().GetProperty(propertyName);
            if (propertyInfo == null) throw new HttpException("Can't find property with name " + propertyName);
        ...
        public static ODataPath CreateODataPath(this HttpRequestMessage request, Uri uri)
        {
            ...
            if (routeData == null) throw new InvalidOperationException("This link is not a valid OData link.");
        ...
        public static TKey GetKeyValue<TKey>(this HttpRequestMessage request, Uri uri)
        {
            ...
            if (keySegment == null) throw new InvalidOperationException("This link does not contain a key.");
